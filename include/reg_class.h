...
/*
  ...
  int handle_slave(int usec = 10000); // for Slave only. Need to call very
  often! int write_raw(int r, uint16_t val); // for Slave only uint16_t
  read_raw(int r);           // for Slave only
